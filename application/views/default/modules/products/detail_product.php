            ...
            <div class="box detail-product">
                ...
                <div class="box-header">
                    <ol class="breadcrumb">
                        ...
                        if ($parent_cat_id > 0):
                            $parent_cat_1 = $this->M_Sanpham->get_parent_cat($parent_cat_id);
                            if ($parent_cat_1->cat_parent > 0):
                                $parent_cat_2 = $this->M_Sanpham->get_parent_cat($parent_cat_1->cat_parent);
                ...
                <div id="detail-product" class="box-body">
                    <div class="row">
                            ...
                            <div class="box-add-product col-md-6 hidden-sm hidden-xs">
                                <div class="row">
                                    ...
                                    <div class="tool-box">
                                        ...
                                        <p>
                                            <label>Tại danh mục: </label> <span class="list-tag"><a href="<?php echo base_url() . "danhmuc/" . $product->cat_slug; ?>"><?php echo $product->cat_name; ?></a></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 hidden-lg hidden-md ">
                            <div class="box-add-product col-sm-6 col-xs-12">
                                <div class="row">
                                    <label>Số lượng</label>
                                    <div class="select-qty">
                ...
                <div class="box-footer">
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active poster-info">
                            ...
                            <label>Số điện thoại</label>: <a href="<?php echo ($shop_info->phone == "0") ? "#" : "phone:0" . $shop_info->phone; ?>"><?php echo ($shop_info->phone == "0") ? "Chưa cập nhật số điện thoại" : "0" . $shop_info->phone; ?></a> <br/>
                        ...
                        <div id="menu3" class="tab-pane fade">
                            ...
                            <img style="width: 80%;" src="http://1.bp.blogspot.com/-OuXZGjs5lMo/TgCOqnsUzTI/AAAAAAAAAZM/P8ZToexRXug/s1600/facebook+social+plugins+2.png" class="img-responsive text-center" />
                        </div>
                    </div>
